...
echo "Generating tools README for src/universal_mcp_apollo/app.py..."
universal_mcp readme src/universal_mcp_apollo/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_apollo/README.md
